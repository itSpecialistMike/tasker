...
const BackgroundBlur: React.FC = () => {
  return (
    <div className="absolute inset-0 -z-10 pointer-events-none">
      ...
      <div className="absolute bottom-[-200px] right-[-200px] w-[500px] h-[500px] rounded-full bg-gradient-to-br from-green-400 via-yellow-400 to-red-400 opacity-30 blur-[90px]" />
    </div>
  );
};
